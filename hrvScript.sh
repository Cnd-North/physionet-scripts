...
# -p option, Plots RR interval as individual points
   plt_rrs  -P 8 -p nsr2db/nsr001 ecg 00:00:00 01:00:00 plt 0 2 -wb 2 -t "Window 2"
...
# is flagged as an outlier and excluded
  plt_rrs  -P 8 -N -F "0.15 20 -x 0.4 2.0" nsr2db/nsr001 ecg 00:00:00 01:00:00 plt 0 1 -wb 1 -t "Window 1"
